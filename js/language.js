...
var language = {
    en: {
        ...
        positions_p: "Few positions with strong technical component are filled by women",
    ...
    es: {
        ...
        positions_title: "Puestos",
        positions_p: "Existen pocos puestos de trabajo con un fuerte componente técnico que son ocupados por mujeres",
    ...
    el: {
        ...
        positions_p: "Λίγες τεχνικές θέσεις είναι καλλυμένες από γυναίκες",
        opportunities_title: "Ευκαιρίες",
        opportunities_p: "Στόχος μας είναι να εντοπίσουμε τις ευκαιρίες και τα εμπόδια",
    ...
    de: {
        ...
        positions_p: "Nur wenige Positionen mit starker technischer Komponente werden von Frauen besetzt",
        opportunities_title: "Chancen",
        opportunities_p: "Wir wollen Chancen und Hindernisse identifizieren udn aufzeigen",
        inspiration_title: "Inspiration",
    ...
    nl: {
        ...
        positions_p: "Slechts enkele posities met een sterke technische component worden ingevuld door vrouwen",
        opportunities_title: "Kansen",
        opportunities_p: "Ons doel is kansen en obstakels te identificeren",
